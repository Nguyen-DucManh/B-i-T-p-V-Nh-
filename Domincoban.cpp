...
const int MAX_SIZE = 10; // kích thước tối đa của bảng đồ
const int MAX_MINES = 10; // số lượng mìn tối đa trên bảng đồ
...
int main() {
    ...
    while (!gameOver) {
        ...
        int x, y;
        cout << "Enter row and column to open (0-based): ";
        cin >> x >> y;
        ...
        if (revealed[x][y]) {
            cout << "This cell has already been revealed, please try again." << endl;
            continue;
        }
